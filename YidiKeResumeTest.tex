...
\address{GitHub: https://github.com/rengokantai \\ Codepen: https://codepen.io/rengokantai \\ Last Update: \today} 
...
Software Engineer with 2 years testing experience. Versed in OO languages such as Java. Experienced with JavaScript and modern JavaScript MV* Frameworks. Fimiliar with DevOps and Mobile Development. Open source, contributed lots of well-known projects.
...
Front-end skills & Angular2/RxJS(Most familiar),JavaScript/jQuery,HTML/CSS/Sass \\
...
I contributed a lot of open source projects, here are some: \\
...
\item Created and maintained internal enterprise-level platform, landing pages and mobile web applications for iPhone/Android platforms using Angular2/Ember, Python/Django
...
\item Performed automation tests using Selenium/Appium,built dev environment using shell scripting.
\item Wrote DevOps scripts. Assist with testing, defect tracking. (Ansible, Teamcity)
\item {\bf Technology in use: Python/Django, Angular2/JavaScript, PostgreSQL, AWS/Ansible/Jenkins/Selenium/Appium }
\item {\bf 40\% Frontend, 40\% Backend/Test, 20\% DevOps }
