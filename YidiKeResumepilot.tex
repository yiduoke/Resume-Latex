...
\address{GitHub: https://github.com/rengokantai \\ Codepen: https://codepen.io/rengokantai \\ Last Update: 10/2017} % Your secondary addess (optional)
...
Software Engineer (Angular2/Vue, Python/Django) with 2 years experience. Versed in OO languages such as Java. Experienced with JavaScript and modern JavaScript MV* Frameworks. Fimiliar with DevOps and Mobile Development. Open source, contributed lots of well-known projects.\\ (U.S. Permanent Resident)
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Languages& Python, Java, Ruby, Scala, Swift \\
Web Development & SASS/Compass/Postcss/Jade/Handlebars,JavaScript(jQuery, lodash, D3.js/Highcharts)\\& Vue/Angular2/RxJS, Node/Express, Twitter Bootstrap, SVG/snap.svg\\&
...
Microsoft VScode, emberfire(emberjs firebase connector) \\
...
\item Created and maintained internal enterprise-level platform, landing pages and mobile web applications for iPhone/Android platforms using Vue, Python/Django
...
\item {\bf Technology in use: Python/Django, Vue/JavaScript, PostgreSQL, AWS/Ansible/Jenkins}
\end{rSubsection}
