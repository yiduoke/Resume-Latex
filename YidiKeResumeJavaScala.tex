...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Languages& Java(Advanced), Python(Intermediate),Scala, Ruby\\
...
%\item Used Java and Spring Boot creating forms and built RESTful APIs, executed PostgreSQL queries using pgjdbc.
...
\item {\bf Technology in use: Java/Scala/Play/gradle, Angular2/TypeScript, PostgreSQL, AWS/Ansible/Jenkins }
