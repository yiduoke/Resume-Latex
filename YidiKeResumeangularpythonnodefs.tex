...
Front-end skills & Angular2 {\bf (2year exp)}/TypeScript/RxJS, React{\bf (4month exp)}/Redux/Flux/GraphQL \\&  Vue.js, Sass/Compass, JavaScript/jQuery, D3/HighCharts, Three.js \\
...
\item Created and maintained internal enterprise-level platform, landing pages and mobile web applications for iPhone/Android platforms using React Native/Angular2/TypeScript/RxJS, Django.
...
\item Built Virtual tour system for colleges and universities,developed UI widgets and functionality modules using React.
...
\item {\bf Technology in use: Sass, Three.js/D3.js/Highcharts, React.js/JavaScript, PHP, Node.js, AWS(EC2, Lambda), MySQL}
