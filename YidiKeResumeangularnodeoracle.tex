...
Front-end skills & Angular2/TypeScript/RxJS(Most familiar), Sass/Compass, JavaScript/jQuery \\&
  D3/HighCharts, Three.js \\
Back-end skills & Node.js/Express/Django \\
Databases & OracleDB, MySQL/MariaDB, PostgreSQL, MongoDB, RethinkDB, Redis, Neo4j \\
...
\item Created and maintained internal enterprise-level platform, landing pages and mobile web applications for iPhone/Android platforms using Angular2, Java/Scala/Play
...
\item Used Java and Spring Boot creating forms and built RESTful APIs, executed PostgreSQL queries using Oracle jdbc.
...
\item {\bf Technology in use: Java/Scala/Play/gradle, Angular2/TypeScript, Oracle Database, AWS/Ansible/Jenkins }
