...
%
%{\bf Cornell University} \hfill {\em August 2018 - December 2021} \\ 
%B.S. in Computer Science (GPA: 3.60)  \\
%\begin{itemize}
%  \item Object-Oriented Programming and Data Structures $\diamond$ Functional Programming in OCaml  $\diamond$ Discrete Mathematics $\diamond$ Probability $\diamond$ Linear Algebra $\diamond$ Multivariable Calculus
%\end{itemize}
