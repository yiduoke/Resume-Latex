...
\usepackage[left=0.75in,top=0.55in,right=0.75in,bottom=0.55in]{geometry} % Document margins
...
\item Built a graphics engine that displays and animates 3D shapes and objects
