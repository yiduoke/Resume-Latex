...
Software Engineer(Python/Django/Angular2) with 2 years experience building high-traffic, client-facing web applications. Versed in OO languages such as Python. Experienced with JavaScript and modern JavaScript MV* Frameworks. Fimiliar with DevOps and Hybrid app Development. Open source, contributed lots of well-known projects.
...
Web Development & Django/Angular2/RxJS,SASS/Compass, JavaScript(jQuery,D3.js/Highcharts)\\& Node/Express, Twitter Bootstrap\\
...
\item Technology in use: Python/Django, celery, fabric, Angular2/JavaScript, PostgreSQL
...
%\item {\bf Flappy Pig (A vanilla JavaScript game)}  Live Demo: http://yidi.me/flappypig/demo/index.html
