...
\item Built various graphs and charts using js libraries such as angular2-d3.
%\item Used node.js and express creating forms and built RESTful APIs, executed PostgreSQL queries using sequalize.
...
\item {\bf Technology in use: Node/Express, Angular2/TypeScript/RxJS, MongoDB/PostgreSQL, AWS/Ansible/Jenkins }
